...
class MessageLookup extends MessageLookupByLibrary {
  ...
  static _notInlinedMessages(_) => <String, Function> {
    ...
    "manualHide" : MessageLookupByLibrary.simpleMessage("隐藏说明"),
    "manualShow" : MessageLookupByLibrary.simpleMessage("显示说明"),
    ...
    "pageEditorFinishAlertDetail" : MessageLookupByLibrary.simpleMessage("全部更改已保存。点击 完成 按钮下载新的 TRPTRANS_MOD.DAT 与 TRPTITLE_MOD.DAT\n*.将它们重命名为 TRPTRANS.DAT 与 TRPTITLE.DAT ，回传至vita覆盖原始文件(回传前请确保vita的原始文件处于解密状态)"),
    ...
    "scriptManualExample" : MessageLookupByLibrary.simpleMessage("例子:"),
    "scriptManualTitle" : MessageLookupByLibrary.simpleMessage("脚本使用JSON格式， 文件名可以为任意.json"),
    "scriptSelect" : MessageLookupByLibrary.simpleMessage("选择脚本"),
    ...
    "staticAnalyzeRange" : MessageLookupByLibrary.simpleMessage("奖杯无法获得的时间区间"),
    "staticAnalyzeRepeat" : MessageLookupByLibrary.simpleMessage("奖杯无法获得的重复时间段"),
    "staticAnalyzeRepeatExample" : MessageLookupByLibrary.simpleMessage("每周2从中午12点开始奖杯有3600秒的时间段无法获得"),
